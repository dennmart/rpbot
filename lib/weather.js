exports.currentConditions = function(weatherLocation) {
  ...
  parser.addListener('end', function(result) {
    ...
    if (response.weather.problem_cause !== undefined) {
      room.speak("I couldn't find any weather conditions for " + weatherLocation + ". Make sure you entered a valid location, or try again later.");
    } else {
      ...
      room.speak("Current weather forecast for " + cityName + ": " + condition + ", " + tempFahrenheit + " °F (" + tempCelsius + " °C) - " + humidity + ", " + windCondition);
    }
  });
};
